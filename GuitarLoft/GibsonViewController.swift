...
class GibsonViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        electricButton.addTarget(self, action: #selector(presentElectricsViewController), forControlEvents: .TouchUpInside)
    ...
    func presentElectricsViewController() {
        
        
        let navigationController = UINavigationController(rootViewController: GibsonElectricsViewController(dataStore: dataStore))
//        let gibsonElectricsViewController: GibsonElectricsViewController = GibsonElectricsViewController(dataStore: dataStore)
